const translations = {
  ...
  privacy_page: {
    ...
    content: `
1. #### Name und Anschrift des Verantwortlichen {.roman value="I."}

Der Verantwortliche im Sinne der Datenschutz-Grundverordnung und anderer nationaler Datenschutzgesetze der Mitgliedsstaaten sowie sonstiger datenschutzrechtlicher Bestimmungen ist die:

_Impax Tours UG (haftungsbeschränkt), Rochusstraße 1_
_52062 Aachen , Deutschland_
...
Diese Website (im Folgenden: die "Website", „Onlinepräsenz“) wird von dem Verantwortlichen (im Folgenden: "uns" oder "wir") bereitgestellt.

2. #### Allgemeines zur Datenverarbeitung {.roman value="II."}

1. ##### Umfang der Verarbeitung personenbezogener Daten {value="1"}
...
3. #### Bereitstellung der Website und Erstellung von Logfiles {.roman value="III."}
    
1. ##### Beschreibung und Umfang der Datenverarbeitung {value="1"}
...
4. #### Verwendung von Cookies {.roman value="IV."}
...
Beim Laden der Website werden Sie gefragt, welche Cookies Sie akzeptieren möchten. Dabei können Sie uns erlauben, ob und in welcher Form, wir Informationen zur Websitennutzung sammeln dürfen.
...
Bei Aktivierung des Cookies wird diesem eine Identifikationsnummer zugewiesen und eine Zuordnung Ihrer personenbezogenen Daten zu dieser Identifikationsnummer wird nicht vorgenommen. Ihr Name, Ihre IP-Adresse oder ähnliche Daten, die eine Zuordnung des Cookies zu Ihnen ermöglichen würden, werden nicht in den Cookie eingelegt. Auf Basis der Cookie-Technologie erhalten wir lediglich pseudonymisierte Informationen, beispielsweise darüber, welche Seiten besucht wurden. Sie können Ihren Browser so einstellen, dass Sie über das Setzen von Cookies vorab informiert werden und im Einzelfall entscheiden können, ob Sie die Annahme von Cookies für bestimmte Fälle oder generell ausschließen, oder dass Cookies komplett verhindert werden. Dadurch ist die Nutzung nicht eingeschränkt.


5. #### Kontaktformulare und E-Mail-Kontakt {.roman value="V."}

Auf unserer Internetseite sind zwei Kontaktformulare vorhanden, welche für die elektronische Kontaktaufnahme genutzt werden können. Nimmt ein Nutzer diese Möglichkeit wahr, so werden die in der Eingabemaske eingegeben Daten an uns übermittelt und gespeichert. Diese Daten sind bei dem auf der Website weiter oben befindlichen Kontaktformular (Überschrift „Nutzen Sie digitale Chancen“): Unternehmensname des Nutzers; Name des Nutzers; Telefonnummer; E-Mail-Adresse; ausgewählte Module, zu denen der Nutzer weitere Informationen erhalten möchte; Bestätigung des Nutzers, die Datenschutzerklärung gelesen zu haben und Einwilligung zur Datenverarbeitung.

Im Zeitpunkt der Absendung der Nachricht werden zudem folgende Daten gespeichert:  Die IP-Adresse des Nutzers; Datum und Uhrzeit.

Die übermittelten Daten sind bei Nutzung des weiter unten befindlichen Kontaktformulars (Überschrift „Kundenservice kontaktieren“): Name des Nutzers; E-Mail-Adresse; Nachrichttext. Im Zeitpunkt der Absendung der Nachricht werden zudem folgende Daten gespeichert:  Die IP-Adresse des Nutzers; Datum und Uhrzeit.
...
Rechtsgrundlage für die Verarbeitung der Daten, die im Zuge einer Übersendung einer E-Mail übermittelt werden, ist Art. 6 Abs. 1 S. 1 lit. f DSGVO. Zielt der E-Mail-Kontakt auf den Abschluss eines Vertrages ab, so ist zusätzliche Rechtsgrundlage für die Verarbeitung Art. 6 Abs. 1 S. 1 lit. b DSGVO. Die Verarbeitung der personenbezogenen Daten aus der Eingabemaske dient uns allein zur Bearbeitung der Kontaktaufnahme. Im Falle einer Kontaktaufnahme per E-Mail liegt hieran auch das erforderliche berechtigte Interesse an der Verarbeitung der Daten.
...
Der Widerruf der Einwilligung und der Widerspruch der Speicherung erfolgen über eine entsprechende Mitteilung. Senden Sie bitte eine E-Mail an <a target="_blank" rel="noopener noreferrer" href="mailto:info@nov-it.de">info@nov-it.de</a> oder schreiben Sie an die unter I. genannten Kontaktdaten.

Alle personenbezogenen Daten, die im Zuge der Kontaktaufnahme gespeichert wurden, werden in diesem Fall gelöscht.


6. #### Rechte der betroffenen Person {.roman value="VI."}

Werden personenbezogene Daten von Ihnen verarbeitet, sind Sie Betroffener i.S.d. DSGVO und es stehen Ihnen folgende Rechte gegenüber dem Verantwortlichen zu:

1. ##### Auskunftsrecht {value="1"}
...
7. #### Name und Anschrift des Datenschutzbeauftragten {.roman value="VII."}
...
8. #### Aktualität und Änderungen der Datenschutzerklärung {.roman value="VIII."}

Dies ist die aktuelle Datenschutzerklärung und hat den Stand September 2019. Wegen Erweiterungen oder Änderungen unserer Website sowie geänderter gesetzlicher oder behördlicher Vorgaben kann eine Anpassung der Datenschutzerklärung dieser Website notwendig sein.
`
  },
...
Umsatzsteuer-Identifikationsnummer gemäß § 27a Umsatzsteuergesetz (UStG): keine ausgestellt
...
Plattform der EU-Kommission zur Online-Streitbeilegung: <a href="https://ec.europa.eu/odr" target="_blank" rel="nofollow noreferrer">https://ec.europa.eu/odr</a>.
